...
export function timeFromUTCToLocal(date: (string | undefined), time: (string|undefined)){
...
export function timeFromLocalToUTC(date: (string | undefined), time: (string|undefined)){
