...
class CloseOrderAdmin(admin.ModelAdmin):
    list_display = ("id", "order", "full", "semi_close", "close", "precinto", "uploaded_at")
class RowAdmin(admin.ModelAdmin):
    list_display = ("id", "order", "number", "product", "size", "image", "quantity")

class TempAdmin(admin.ModelAdmin):
    list_display = ("id", "order", "row", "temp")

class WeightAdmin(admin.ModelAdmin):
    list_display = ("id", "order", "package", "carton", "primary_package", "product")
